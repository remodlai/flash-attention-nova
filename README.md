# FlashAttention for Nova

This is a fork of https://github.com/Dao-AILab/flash-attention customized for Nova.

We have the following customizations:

- Build: Cmake, torch library (this package is bundled into Nova).
